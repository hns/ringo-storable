...
var Storable = exports.Storable = function() {};
...
Storable.defineEntity = function(store, type, mapping) {
    ...
    ctor.createInstance = function(key, entity) {
        return Object.create(ctor.prototype, {
            _key: {value: key, writable: true, configurable: true},
            _entity: {value: entity, writable: true, configurable: true}
        });
    };
    ...
    ctor.toString = function() {return "function " + type + "() {}"};
...
Storable.toString = function() "function Storable() {}";
